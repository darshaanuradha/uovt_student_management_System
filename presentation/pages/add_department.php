<div class="min-h-full flex flex-col">
    ...
    <nav class="mb-6 flex items-center gap-2 text-sm text-emerald-500">
        ...
        <span class="text-emerald-700 font-medium">Add Department</span>
    </nav>
    ...
    <div class="mb-8 flex items-start gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-emerald-900 tracking-tight">Add New Department</h1>
            <p class="text-sm text-emerald-500 mt-0.5">Fill in the details to create a new department.</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl border border-emerald-100 shadow-sm overflow-hidden max-w-2xl w-full">
        ...
        <form action="../application/departmentsController.php" method="POST" class="px-6 py-7 space-y-6">
            ...
            <div>
                ...
                <input type="text" name="dept_name" required placeholder="e.g. Software Engineering"
                    class="w-full px-4 py-2.5 rounded-xl border border-emerald-200 text-emerald-900 placeholder-emerald-300 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all duration-200">
            </div>
