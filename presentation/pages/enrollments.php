<div class="flex justify-between items-center mb-6 border-b border-emerald-100 pb-4">
    ...
    <div class="space-x-4">
        <a href="enroll_student_form.php" class="bg-emerald-600 text-white px-4 py-2 rounded shadow hover:bg-emerald-700 transition font-semibold">+ New Enrollment</a>
